...
| V5 | + any risk gene inside the candidate's own TAD, not just flanking/radius (criterion 8) | `candidates_scored_v5.tsv`, `candidates_passing_ranked_v5.bed` | 43 / 461 | Unchanged from V4 — only 2 newly excluded, top candidate's TAD is clean |
