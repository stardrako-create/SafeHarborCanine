...
def missing_score_components(candidate, weights):
...
def main():
    ...
    for c in candidates:
        ...
        # A partial weighted score is descriptive, not evidence that every
        # requested component was measured. Keep each absent component explicit.
        missing.extend(missing_score_components(c, weights))
