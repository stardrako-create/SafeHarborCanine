...
candidato_top_05_SHIP_v1: "NC_051812.1:52,431-118,675 (ROS_Cfam_1.0, score 0.83, confirmado independentemente pelo Ehsan)"
...
última_revisão: 2026-09-06
---

# 00 · MOC — Safe Harbor Canino para CAR-T

> [!abstract] Estado do projeto
> **Objetivo:** identificar e justificar um locus candidato a *genomic safe harbor* no cão para integração estável de um transgene em contexto de CAR-T.  
> **Candidato computacional atual (V9-B2, ROS_Cfam_1.0):** `NC_051805.1:7,072,137–7,132,579`; top 1 de uma shortlist de cinco, com 26/461 sobreviventes.  
> **Candidato histórico de scouting:** `chr12:72,350,025–72,351,060` em UU_Cfam_GSD_1.0; não é o candidato final do pipeline.  
> **Estado:** shortlist computacional robusta, ainda sem validação funcional; gRNA/off-targets dependem da definição de Cas/PAM e constructo.  
> **Escopo do Manuel:** discovery, filtragem, ranking e justificação bioinformática do locus. A validação funcional da CAR-T fica a cargo da equipa experimental.
