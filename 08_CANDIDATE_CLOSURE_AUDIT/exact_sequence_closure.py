...
lock=open('/tmp/safeharbor_exact_closure.lock','w');fcntl.flock(lock,fcntl.LOCK_EX|fcntl.LOCK_NB)
...
rows=list(csv.DictReader((P/'07_FINAL_CANDIDATES_2026-09-19/shortlist_evidence.tsv').open(),delimiter='\t'));patterns={};windows=[]
for r in rows:
