> Auditoria adicional ativa em 19 setembro: painel provisório; ver [[Safe Harbor CAR-T - Auditoria adicional de fecho - 2026-09-19]]. TAD avaliado em três escalas, sem validação em CAR-T.
...
tags:
  ...
  - GEG-SH
status: ativo
versao_atual: v1.22.6
estado_atual: "3 passam verificações registadas (ANO2/NTF3 #1, NPNT/TBCK #2, LOC119876429/LOC119872513 #3), inalterado desde v1.21.3; ATAC totalmente reconstruído e verificado (v1.21.8); RNA-seq CAR-T caninas reprocessado do zero (v1.22.6) — ANO2/NTF3 quase indetetados, CD247/CD8B fortemente expressos; nenhum safe harbor validado"
...
última_revisão: 2026-09-18
---

# 00 · MOC — Safe Harbor Canino para CAR-T

> [!important] Seleção computacional fechada —19 setembro2026
> [[Safe Harbor CAR-T - Painel final para validacao - 2026-09-19]]. w01 prioridade; w11 condicionada; w03 reserva. Zero loci biologicamente validados.


> [!info] v1.23.1 — teste dos mates concluído
> [[Safe Harbor CAR-T - v1.23.1 teste mates concluido - 2026-09-19]]. 27/27 verificados; R1 e R2 informativos. Não confirma o kit nem valida safe harbor.


> [!warning] v1.23.0 — protocolo ainda não reconciliado
> [[Safe Harbor CAR-T - v1.23.0 auditoria protocolo - 2026-09-19]]. Auditoria de 1,8 milhões de reads; sem alteração de trimming nem nova recontagem.


> [!info] v1.22.9 — contexto dos 40 genes
> [[Safe Harbor CAR-T - v1.22.9 contexto 40 genes - 2026-09-19]]. 15 símbolos ausentes da tabela publicada agora avaliáveis; RNA não valida safe harbor.


> [!info] v1.22.8 — concordância com RNA publicado
> [[Safe Harbor CAR-T - v1.22.8 concordancia RNA publicado - 2026-09-19]]. 9/9 rótulos concordantes; conflitos de origem não resolvidos por esta comparação.


> [!success] v1.22.7 — recontagem corrigida concluída e verificada em 19 setembro
> [[Safe Harbor CAR-T - v1.22.7 recontagem concluida - 2026-09-19]]. Nove amostras, 42.309 genes. Substitui estados anteriores de execução; não constitui validação biológica de safe harbor.
...
> [[Safe Harbor CAR-T - v1.22.6 RNA bruto em execucao - 2026-09-16]]. Downloads com MD5, índice STAR e fila iniciados. Ainda sem novas contagens. Último relatório de resultados concluídos: v1.22.5.


> [!important] Estado mais recente: v1.22.5
> [[Safe Harbor CAR-T - v1.22.5 desenho genes e reads - 2026-09-16]] — três cães emparelhados confirmados no artigo; genes ausentes não recuperados por sinónimos; nove runs brutos localizados (63,9 GB), ainda não reprocessados. Sem alteração da shortlist.


> [!important] Estado mais recente: v1.22.4 — 16 setembro
> [[Safe Harbor CAR-T - v1.22.4 expressao CAR-T canina - 2026-09-16]]; [[Safe Harbor CAR-T - Relatorio atualizado - 2026-09-16]]. Contexto RNA CAR-T analisado; genes vizinhos expressos e quatro conflitos de metadados registados. Sem alteração da shortlist ou validação funcional.


> [!important] Estado mais recente: v1.22.3
> [[Safe Harbor CAR-T - v1.22.3 profundidade e fontes CAR-T - 2026-09-15]] — RNA-seq CAR-T canino GSE247355 descarregado; profundidade reduzida nos T do multiome limita a interpretação dos zeros. Sem alteração da shortlist.


> [!important] Estado mais recente: v1.22.2 — 15 setembro
> [[Safe Harbor CAR-T - v1.22.2 correspondencia LOC e NPNT - 2026-09-15]]; [[Safe Harbor CAR-T - Relatorio atualizado - 2026-09-15]]. Correspondência central LOC sustentada e variantes suplementares consultadas; flancos complexos. Alternativas NPNT parciais/imperfeitas. Sem safe harbor validado. Entradas seguintes são histórico.


> [!important] Estado mais recente: v1.22.1
> [[Safe Harbor CAR-T - v1.22.1 auditoria local alternativas - 2026-09-14]] — 16 alternativas revistas, 15 consultas de variantes elegíveis; uma janela LOC com correspondência a resolver e uma NPNT com alternativas de alinhamento local. Nenhum safe harbor validado. Entradas seguintes são histórico.
...
> [!success] Atualização — 2026-09-14/18 — ATAC totalmente reconstruído (v1.21.8) e RNA-seq real de CAR-T caninas reprocessado do zero (v1.22.6)
> **As mesmas 3 regiões continuam a passar, scores praticamente inalterados** (ANO2/NTF3 0,5072→0,5073) depois de uma reconstrução ATAC completa e verificada dos 76 cães (95M+ bins conferidos, 18 testes de regressão) — confirma que o "risco conhecido" de v1.21.3 nunca foi real. Modelo phyloP trocado do piloto para o modelo publicado UCSC/Zoonomia (valores desceram ~15-20%, continuam bem abaixo do veto). As 64 janelas alternativas foram auditadas (variantes, mapeabilidade, conservação); a ambiguidade de mapeamento da janela central do LOC foi resolvida por alinhamento recíproco (984/984 coordenadas concordam).
>
> **Encontrados dados públicos reais de RNA-seq de CAR-T caninas**: GSE247355 (Cao et al. 2024, PMID 38554158) — 3 cães × 3 condições (T não transduzida, CAR B7-H3, CAR B7-H3+CXCR2). Ao aplicar a matriz publicada, 15 dos 40 genes de contexto verificados — incluindo **ANO2, NTF3, CD247, CD8B e ambos os genes LOC** — estavam simplesmente ausentes da matriz (não resolvido por sinónimos NCBI). Em vez de desistir, foram localizados e **reprocessados do zero os 9 ficheiros FASTQ brutos** (~64GB) com a anotação ROS atual.
>
> **Resultado: os 15 genes têm agora contagens reais.** Os 4 que importam para o projeto: **ANO2** (4,0,3,0,0,0,1,1,0 reads) e **NTF3** (0,0,0,4,0,0,0,0,0) — praticamente indetetados, contra profundidades de milhares noutros genes das mesmas bibliotecas; já não é uma lacuna de anotação, é sinal real de expressão muito baixa/ausente. **CD247** (12113…14546) e **CD8B** (12365…977, com gradiente real entre dadores) — fortemente expressos, como esperado para genes marcadores de células T, o que também confirma que o reprocessamento está correto. Os dois genes LOC da região candidata **comportam-se de forma diferente entre si**: LOC119876429 tem expressão real modesta (11-32 reads); LOC119872513 é zero absoluto nas 9 amostras.
>
> Nenhum teste de expressão diferencial foi feito (só contagens brutas); strandedness não foi assumido (3 orientações preservadas). Não altera acessibilidade, segurança de integração nem o estado de nenhum candidato — fecha uma lacuna de contexto de expressão, não mais. Detalhe técnico completo: `06_v1.21.8` a `06_v1.22.6` (CURRENT.md/RELATORIO em cada pasta). Notas de infraestrutura reais encontradas a corrigir o pipeline de reprocessamento (FIFO do STAR incompatível com discos Windows montados no WSL, processos órfãos ao matar um processo-pai no Windows, `curl --max-time` pouco fiável) ficaram corrigidas permanentemente em `06_v1.22.6/run_cart_queue_v1226.py`.
...
> [!important] Estado atual — 2026-09-18 — v1.22.6
...
> **Estado atual:** 461 regiões; 457 excluídas, 1 com evidência insuficiente, **3 passam verificações registadas**: ANO2/NTF3 (`NC_051831.1:39677324-39739751`, score 0,5073, #1), NPNT/TBCK (`NC_051836.1:27013911-27071204`, 0,5015, #2), LOC119876429/LOC119872513 (`NC_051811.1:17217706-17274511`, 0,3984, #3). Nenhum safe harbor validado. ATAC totalmente reconstruído e verificado (v1.21.8, scores praticamente inalterados). RNA-seq real de CAR-T caninas (GSE247355) reprocessado do zero (v1.22.6) — ver atualização acima para os genes ANO2/NTF3/CD247/CD8B.
> **Análise detalhada e critérios de fecho:** [[Safe Harbor CAR-T canina - Analise integrada e fecho do protocolo 2026-09-12]] (histórico, ver atualizações mais recentes para o estado atual).
