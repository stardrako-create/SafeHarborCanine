...
A=Path(__file__).parent/'SV_PBGV000010/alignment_chunked';O=A/'local_extension_20260922_k31';O.mkdir(exist_ok=True)
ref='/mnt/d/Jin2024_work/uu_gsd/genome_uu_gsd.fa';chrom='NC_049253.1';K=31
