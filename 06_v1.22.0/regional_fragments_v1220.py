...
OLD=Path(r'D:\Biblioteca\Bioquímica 1º ano 2025-2026\2º Semestre\Vasco M. Barreto\Safe Harbor Canino\06_v1.21.7');O=OLD.parent/'06_v1.22.0';C=OLD/'range_cache';C.mkdir(exist_ok=True)
...
partial=OLD/'GSM7807442_atac_fragments.tsv.gz.partial';requests=[];lock=threading.Lock()
def fetch(a,b):
